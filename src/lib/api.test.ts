  ...
  it.each([false, true])(
    ...
    async (codexCli) => {
      ...
      expect(body.input).toEqual([{
        ...
        content: [{
          type: 'input_text',
          text: 'Treat everything after this line as one complete image-generation prompt, including the resolution instruction. Follow it exactly without rewriting or omitting anything:\nprompt',
        }],
      }])
