            ...
            <h1 className="inline-flex min-w-0 items-start relative mr-2">
              {showFavoriteCollectionTitle ? (
                <>
                  ...
                  <span className="hidden text-lg font-bold tracking-tight text-gray-800 dark:text-gray-100 sm:inline">生图中心</span>
                </>
              ) : (
                <span className="text-[17px] font-bold tracking-tight text-gray-800 dark:text-gray-100 sm:text-lg">生图中心</span>
              )}
            </h1>
