                  ...
                  <div className="mb-1.5 flex items-center justify-between gap-3">
                    ...
                    <div className="w-28 shrink-0">
                      <Select
                        ...
                        className={`w-full rounded-xl border border-gray-200/70 bg-white/60 px-3 py-1.5 text-xs text-gray-700 outline-none transition focus:border-blue-300 dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-gray-200 dark:focus:border-blue-500/50 ${apiConfigReadOnly ? 'cursor-default opacity-70' : ''}`}
                      />
                    </div>
                  </div>
                  <div data-selectable-text className="mt-1.5 text-xs text-gray-500 dark:text-gray-500">
